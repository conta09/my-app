    ...
    <div className="h-[80vh] flex flex-col justify-center   sm:ml-5 lg:ml-20">
      ...
      <h1 className="lg:w-[70%] text-white   text-7xl sm:4xl lg:leading-snug my-auto   ">
       ...
       <IoLogoInstagram size={20} className="mt-1 mx-2" />
        ...
        <p className='font-light text-[#aeadad] lg:w-1/3'>In the last 2 years, I've specialized in web and dta analytics for clients ranging from startups to Fortune 500 companies, and everything in between</p>
