  ...
  return (
    <div className=' flex h-[50vh]  '>
      <div className="w-[60%] ml-20 pt-4 my-auto">
        ...
        <p className='my-5 w-2/3 font-medium text-[#878686]'>I'm currently looking for new opportunities, my inbox is always open. Whether you have a question or just want to say hi, I'll try my best to get back to you!</p>
